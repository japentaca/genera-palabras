...
section('Core');
var data = JSON.parse(fs.readFileSync(path.resolve(__dirname, '..', 'public', 'data', 'data.json'), 'utf-8'));
...
var out1 = spawnSync('node', [path.resolve(__dirname, '..', 'markov.js'), 'public/data/data.json', '3', '2']);
...
// 3. walk.js CLI
section('walk.js CLI');
var out2 = spawnSync('node', [path.resolve(__dirname, '..', 'walk.js'), 'public/data/surreal.json', '20', '1', '1']);
...
// 4. song.js CLI
section('song.js CLI');
var cacheFile = path.resolve(__dirname, '..', 'public', 'data', 'songs', 'smoke_test.json');
if (fs.existsSync(cacheFile)) fs.unlinkSync(cacheFile);
var out3 = spawnSync('node', [path.resolve(__dirname, '..', 'song.js'), 'public/data/surreal.json', '--name', 'smoke_test']);
...
var out4 = spawnSync('node', [path.resolve(__dirname, '..', 'song.js'), 'public/data/surreal.json', '--name', 'smoke_test']);
...
var out5 = spawnSync('node', [path.resolve(__dirname, '..', 'song.js'), 'public/data/surreal.json', '--name', 'smoke_test', '--regen']);
